    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_category', models.CharField(choices=[('Clothing', 'Clothing'), ('Hiking Gear', 'Hiking Gear'), ('Food', 'Food'), ('Medical', 'Medical'), ('Miscellaneous', 'Miscellaneous')], default='Miscellaneous', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_history_last_use_date', models.DateTimeField(auto_now=True, null=True)),
