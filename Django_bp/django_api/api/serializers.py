...
class TripSerializer(ModelSerializer):
    inventory_trip = InventoryContentsSerializer(many=True)
    class Meta:
        model = Trip
        fields = ['id', 'trip_name', 'trip_start_point', 'trip_end_point', 'trip_account', 'inventory_trip']
