...
class AssignHikers extends StatefulWidget {
  const AssignHikers({
    super.key,
    required this.trip,
  });
  ...
  @override
  _AssignHikersState createState() => _AssignHikersState();
}

@override
@override
class _AssignHikersState extends State<AssignHikers> {
    ...
    return Scaffold(
      ...
      body: Column(children: [
                ...
                child: Column(children: [
                  ListTile(
                    onTap: () => {
                      ...
                      setState(() => selected[index] = select),
                      if (selected[index] == true &&
                          !hikerTrip.contains(hikerP.hikers[index].hiker_id))
                        {
                          hikerTrip.add(hikerP.hikers[index].hiker_id),
                          tripP.updateTrip(hikerTrip[index], trip)
                        }
                      else
                        {hikerTrip.remove(hikerP.hikers[index].hiker_id)},
                      print(hikerTrip),
                      select = !select
                    },
                    tileColor: selected[index] ? Colors.blue : Colors.amber,
        ...
        ElevatedButton(
            ...
            onPressed: () {
              Navigator.of(context).pop((context) => FormWidgetsDemo(
                    trip: trip,
                  ));
            },
            child: Icon(
